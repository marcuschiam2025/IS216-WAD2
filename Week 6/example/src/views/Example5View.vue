<script setup>
    import Product from '../components/Product3.vue'
...
<template>
    <div :style="{ 'font-size': fontSize + 'em' }">
        <Product v-for="product in productData" v-bind:key="product.id" v-bind:prod="product"
                v-on:enlarge="fontSize += 0.1" @shrink="fontSize -= 0.1"
        />
